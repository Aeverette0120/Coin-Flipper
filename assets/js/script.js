...
//IIFE
(function() {
// Select all my elements (hungarian notatoin $)
...
// number of heads increase by 1
scoreBoard.heads +=1;
//percentage head to increase
...
function handleClearButtonClick(){
    ...
    //make sure the html shows all zeroes
    changeScoreBoardNumbers();

    // change message to say "Let's Get Rolling!"
    $message.textContent = "Let's Get Rolling!";
}

function setupEventListeners() { $flipbutton.addEventListener('click', function(){
